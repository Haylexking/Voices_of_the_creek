...
| **Part 1 (Figure 1)** | `IMG-20260526-WA0116.jpg` | Inline image in `post-1.html` (first body section) | Historic waterfront of Old Calabar, or traditional wooden canoes cruising the Cross River creeks. | **16:9** (Landscape) | `"traditional canoe Niger Delta"`, `"waterfront creek Nigeria"` |
...
| **Part 3 (Figure 6)** | `IMG-20260526-WA0123.jpg` | Inline image in `post-3.html` (second body section) | An elder-led storytelling session with younger children in a community or compound setting. | **16:9** (Landscape) | `"African village storytelling"`, `"African elder speaking children"`, `"oral tradition"` |
